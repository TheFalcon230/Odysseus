...
namespace Odysseus
{
	...
	void ImGuiLayer::OnImGuiRender()
	{
		...
		CreateDockingWidget(&show);

		ShowSettingWidget(&show);
	}

	void ImGuiLayer::CreateDockingWidget(bool* open)
	{
	...
	//     }
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				{
					ODC_CORE_INFO("New scene created !");
				}
				if (ImGui::MenuItem("Open", "Crtl + O"))
				{
					ODC_CORE_INFO("Opening Scene !");
				}
	...
	void ImGuiLayer::ShowSettingWidget(bool* open)
	{
		ImGui::Begin("Editor Settings");

		if (ImGui::CollapsingHeader("Rendering"))
		{
			const char* item[] = { "Dark", "Light" };
			static int item_current = 0;

			//ImGui::Combo("Themes", &item_current, item, IM_ARRAYSIZE(item));
